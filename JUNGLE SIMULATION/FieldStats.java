...
public class FieldStats {
    // Counters for each type of organisms (plants and animals) in the simulation.
    ...
    /**
     * Generate counts of the number of organisms. These are not kept up to date as
     * organisms are placed in the field, but only when a request is made for the
     * information.
     * 
