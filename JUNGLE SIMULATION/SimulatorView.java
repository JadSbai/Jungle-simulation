 ...
 * setColor method. It also shows the current time for the simulation
 * 
...
public class SimulatorView extends JFrame {
    ...
    private final String INFECTED_PREFIX = "Animals infected: ";
    private JLabel stepLabel, population, infoLabel, hourLabel, infectedAnimals;
    ...
    /**
     * Create a view of the given width and height. It includes statistics (e.g.
     * population, infected animals etc.) in the view
     * 
    ...
    public SimulatorView(int height, int width) {
        ...
        infectedAnimals = new JLabel(INFECTED_PREFIX, JLabel.CENTER);
        ...
        JPanel animalPane = new JPanel(new BorderLayout());
        infoPane.add(stepLabel, BorderLayout.WEST);
        infoPane.add(infoLabel, BorderLayout.CENTER);
        infoPane.add(hourLabel, BorderLayout.EAST);
        contents.add(infoPane, BorderLayout.NORTH);
        contents.add(fieldView, BorderLayout.CENTER);
        contents.add(animalPane, BorderLayout.SOUTH);
        animalPane.add(population, BorderLayout.CENTER);
        animalPane.add(infectedAnimals, BorderLayout.WEST);
    ...
    public void showStatus(int step, Field field) {
        ...
        // This code displays the current hour of the simulation
        int hour = field.getHour();
        hourLabel.setText(HOUR_PREFIX + hour + ":00");
        ...
        for (int row = 0; row < field.getDepth(); row++) {
            for (int col = 0; col < field.getWidth(); col++) {
                ...
                if (organism != null) {
                    ...
                    if (((Organism) organism).isInfected())
                        infected++;
                } else {
        ...
        infectedAnimals.setText(INFECTED_PREFIX + infected);
